...
from .animely import (
    AnimelyAnime,
    search_animely,
    get_anime_episodes as get_animely_episodes,
)  # noqa: F401
...
PROVIDERS = {
    ...
    "anizle": {"name": "Anizle", "adapter": None, "enabled": True, "priority": 2},
    "animely": {"name": "Animely", "adapter": None, "enabled": True, "priority": 3},
    "tranime": {"name": "TRAnimeİzle", "adapter": None, "enabled": True, "priority": 4},
}


def register_provider(
    name: str, adapter_class, enabled: bool = True, priority: int = 5
):
